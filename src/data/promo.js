export const promos = [
	...
	},
	{
		...
		altText: 'Apple Trade In',
		buttons: [
			{ title: 'Get your estimate', type: 'primary', link: '#', id: 3 },
		],
	},
	{
		id: 18,
		...
		title: {
			alt: '',
			type: 'image',
			image: '/img/promo/title-card.png',
		},
		subtitle: 'Get up to 3% Daily Cash back with every purchase.',
		imageDesktop: '/img/promo/card.jpg',
		imageMobile: '/img/promo/card-mobile.jpg',
		altText: 'Apple Card',
		buttons: [
			{ title: 'Learn more', type: 'primary', link: '#', id: 3 },
			{ title: 'Apply now', type: 'outline', link: '#', id: 4 },
		],
	},
];
